        ...
        "layer": [
            {
                ...
                "encoding": {
                    "y": {"field": "linepack_pressure_kg_cm2", "type": "quantitative", "title": "Line-Pack Pressure (kg/cm²)", "scale": {"domain": [75, 86]}}
                }
            },
            {
...
def build_report_surface(data: Any, surface_id: str) -> List[types.Part]:
    ...
    kpi_comp = {
        ...
        "text": (
            ...
            f"• Cloud Storage & Live Report URI: {html_path}"
        ),
        "variant": "body",
    }
