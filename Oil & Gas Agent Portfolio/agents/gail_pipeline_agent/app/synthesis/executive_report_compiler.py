...
<body>
    ...
    <div class="publication-sheet" contenteditable="true" spellcheck="false">
        ...
        <div class="inst-header">
            <div class="inst-header-left">
                ...
                <div class="inst-crest-titles">
                    ...
                    <div class="crest-tagline-bar">Executive Thesis &amp; Operational Advisory · Project Sanchay &amp; Project Navodaya</div>
                </div>
            </div>
            <div class="inst-header-right">
                <div style="text-align: right;">
                    <div style="font-size: 14px; font-weight: 800; color: var(--gail-navy);">REF: GAIL/NGMC/THESIS/{period_date}</div>
                    <div style="font-size: 12px; color: var(--slate-muted);">Transmission Backbone: 18,700 km</div>
                    <div style="font-size: 12px; color: var(--slate-muted);">National Market Share: ~70% (122 MMSCMD)</div>
                </div>
            </div>
        </div>
        ...
        <div class="preamble-card">
            <p><strong>Executive Thesis:</strong> GAIL (India) Limited operates India's vital natural gas arterial grid spanning 18,700 km, dispatching ~122 MMSCMD across anchor fertilizer complexes, power plants, and CGD networks. In multi-thousand-kilometer gas pipelines, downstream draw surges manifest 12–14 hours later due to 35 km/h sonic gas velocity. Standard reactive SCADA throttling incurs severe linepack deficits and unnecessary compressor fuel burn.</p>
            <p>This <em>Executive Briefing &amp; Optimization Thesis</em> synthesizes Yokogawa SCADA linepack telemetry, Siemens RDS turbine thermal logs, Google DeepMind WeatherNext 3 catchment flood overlays, and multivariate econometric SARIMAX (s=24) linepack depletion modeling. By proactively adjusting Vijaipur compression by +3.8% ahead of the T+14h draw peak, GAIL secures downstream delivery pressure commitments while delivering 18,500 SCM/day fuel gas reduction (<strong>₹16.88 Cr / yr</strong> under <em>Project Sanchay</em>), staged automatically into RISE with SAP S/4HANA (<em>Project Navodaya</em>).</p>
        </div>
